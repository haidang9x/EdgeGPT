...
HEADERS_INIT_CONVER = {
    ...
    "sec-ch-ua": '"Not/A)Brand";v="99", "Microsoft Edge";v="116", "Chromium";v="116"',
    "sec-ch-ua-arch": '"x86"',
    "sec-ch-ua-bitness": '"64"',
    "sec-ch-ua-full-version": '"116.0.1938.69"',
    "sec-ch-ua-full-version-list": '"Not/A)Brand";v="99.0.0.0", "Microsoft Edge";v="116.0.1938.69", "Chromium";v="116.0.0.0"',
    "sec-ch-ua-mobile": "?0",
    "sec-ch-ua-model": '""',
    "sec-ch-ua-platform": '"Windows"',
    "sec-ch-ua-platform-version": '"15.0.0"',
